...
class ItemCarrito {
  ...
  String? get imagenUrl =>
      esPromocion ? promocion!.imagenUrl : producto!.imagenUrl;
  ...
  factory ItemCarrito.fromJson(Map<String, dynamic> json) {
    return ItemCarrito(
      ...
      producto: ProductoModel(
        ...
        rating: 0,
        totalResenas: 0,
        proveedorLatitud: json['proveedor_latitud'] != null
            ? double.tryParse(json['proveedor_latitud'].toString())
            : null,
        proveedorLongitud: json['proveedor_longitud'] != null
            ? double.tryParse(json['proveedor_longitud'].toString())
            : null,
      ),
...
class ProveedorCarrito extends ChangeNotifier {
  ...
  int get cantidadTotal {
    ...
    final promosCount = _promocionesLocales.fold(
      0,
  ...
  double get total {
    ...
    final promosTotal = _promocionesLocales.fold(
      0.0,
  ...
  Future<bool> agregarPromocion(
    ...
    debugPrint(
      'Promoción agregada localmente: ${promocion.titulo} con ${productosIncluidos.length} productos',
    );
    return true;
  }
